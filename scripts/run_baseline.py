...
前置：要先跑 scripts/prepare_samples.py 產出樣本檔。
...
from imood_emotion import preprocess, source  # noqa: E402
from imood_emotion.classifier import (  # noqa: E402
    MODEL_ID,
    EmotionClassifier,
    resolve_device,
)
from imood_emotion.downstream import DownstreamWriter  # noqa: E402
from imood_emotion.recorder import Recorder  # noqa: E402
...
def main():
    ...
    # 會被 checks/summarize.py 當成評估結果讀進去
